...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    CharacterShadow: tx({ id: "CharacterShadow", atlas: 0, x: 701, y: 524, width: 80, height: 19 }),
    ...
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 599, y: 601, width: 49, height: 47 }),
    },
    Foliage: {
      Bush0: tx({ id: "Foliage.Bush0", atlas: 0, x: 0, y: 629, width: 254, height: 125 }),
      Flower0: tx({ id: "Foliage.Flower0", atlas: 0, x: 833, y: 557, width: 36, height: 24 }),
      Grass0: tx({ id: "Foliage.Grass0", atlas: 0, x: 501, y: 524, width: 100, height: 43 }),
      ...
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 701, y: 572, width: 51, height: 47 }),
    ...
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 384, y: 489, width: 54, height: 8 }),
    ...
    Hints: {
      ...
      Arrow: tx({ id: "Hints.Arrow", atlas: 0, x: 782, y: 524, width: 24, height: 17 }),
      Book: tx({ id: "Hints.Book", atlas: 0, x: 878, y: 526, width: 113, height: 68 }),
      Move: tx({ id: "Hints.Move", atlas: 0, x: 701, y: 544, width: 75, height: 27 }),
    },
    Hud: {
    ...
    Shapes: {
      LightSmall0: tx({ id: "Shapes.LightSmall0", atlas: 0, x: 1004, y: 356, width: 19, height: 7 }),
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 992, y: 526, width: 32, height: 32 }),
      VSmall0: tx({ id: "Shapes.VSmall0", atlas: 0, x: 782, y: 542, width: 19, height: 13 }),
    },
    Stone: {
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 971, y: 331, width: 53, height: 24 }),
      Rock1: tx({ id: "Stone.Rock1", atlas: 0, x: 501, y: 568, width: 97, height: 48 }),
    },
    Treasures: {
      Bone0: tx({ id: "Treasures.Bone0", atlas: 0, x: 602, y: 524, width: 98, height: 76 }),
      Heart0: tx({ id: "Treasures.Heart0", atlas: 0, x: 777, y: 557, width: 55, height: 42 }),
    },
  };
}
