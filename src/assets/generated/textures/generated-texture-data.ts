...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    CharacterShadowSmall: tx({ id: "CharacterShadowSmall", atlas: 0, x: 154, y: 579, width: 47, height: 13 }),
    ...
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 435, y: 563, width: 49, height: 47 }),
    ...
    Enemy: {
      ...
      GoonHurt: tx({ id: "Enemy.GoonHurt", atlas: 0, x: 4002, y: 1353, width: 92, height: 141 }),
      ...
      PencilProjectile: tx({ id: "Enemy.PencilProjectile", atlas: 0, x: 4074, y: 1300, width: 19, height: 52 }),
      SpiderHurt: tx({ id: "Enemy.SpiderHurt", atlas: 0, x: 0, y: 670, width: 58, height: 38 }),
    ...
    Foliage: {
      ...
      DeadBush1: tx({ id: "Foliage.DeadBush1", atlas: 0, x: 4069, y: 45, width: 26, height: 42 }),
      Flower0: tx({ id: "Foliage.Flower0", atlas: 0, x: 3471, y: 682, width: 36, height: 24 }),
      Grass0: tx({ id: "Foliage.Grass0", atlas: 0, x: 3978, y: 938, width: 100, height: 43 }),
      Grass1: tx({ id: "Foliage.Grass1", atlas: 0, x: 280, y: 636, width: 47, height: 25 }),
      Grass2: tx({ id: "Foliage.Grass2", atlas: 0, x: 2236, y: 180, width: 101, height: 14 }),
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 491, y: 520, width: 51, height: 47 }),
      PineTree0: tx({ id: "Foliage.PineTree0", atlas: 0, x: 3405, y: 589, width: 65, height: 124 }),
      Trunk0: tx({ id: "Foliage.Trunk0", atlas: 0, x: 4079, y: 938, width: 11, height: 84 }),
    },
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3158, y: 917, width: 54, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 3908, y: 53, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 3908, y: 88, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 3908, y: 123, width: 102, height: 24 }),
    ...
    Hints: {
      ...
      ArrowPerspective0: tx({ id: "Hints.ArrowPerspective0", atlas: 0, x: 415, y: 585, width: 18, height: 23 }),
      Arrow: tx({ id: "Hints.Arrow", atlas: 0, x: 4072, y: 585, width: 24, height: 17 }),
      ...
      Cross1: tx({ id: "Hints.Cross1", atlas: 0, x: 3672, y: 994, width: 35, height: 29 }),
      Cross2: tx({ id: "Hints.Cross2", atlas: 0, x: 59, y: 670, width: 21, height: 19 }),
      Cross: tx({ id: "Hints.Cross", atlas: 0, x: 219, y: 597, width: 60, height: 53 }),
      ...
      Move: tx({ id: "Hints.Move", atlas: 0, x: 4011, y: 123, width: 75, height: 27 }),
    ...
    Hud: {
      ...
      Energy: tx({ id: "Hud.Energy", atlas: 0, x: 366, y: 585, width: 48, height: 22 }),
      Life: tx({ id: "Hud.Life", atlas: 0, x: 3672, y: 1024, width: 30, height: 22 }),
    ...
    Shapes: {
      Confetti64: tx({ id: "Shapes.Confetti64", atlas: 0, x: 154, y: 597, width: 64, height: 64 }),
      Ellipse0: tx({ id: "Shapes.Ellipse0", atlas: 0, x: 3413, y: 429, width: 53, height: 14 }),
      LightSmall0: tx({ id: "Shapes.LightSmall0", atlas: 0, x: 4001, y: 45, width: 19, height: 7 }),
      LightSmall1: tx({ id: "Shapes.LightSmall1", atlas: 0, x: 3218, y: 524, width: 7, height: 9 }),
      ...
      VSmall0: tx({ id: "Shapes.VSmall0", atlas: 0, x: 415, y: 609, width: 19, height: 13 }),
      Zigzag0: tx({ id: "Shapes.Zigzag0", atlas: 0, x: 328, y: 636, width: 37, height: 27 }),
    },
    Stone: {
      ...
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 4015, y: 834, width: 53, height: 24 }),
      Rock1: tx({ id: "Stone.Rock1", atlas: 0, x: 3978, y: 1041, width: 97, height: 48 }),
      Wall0: tx({ id: "Stone.Wall0", atlas: 0, x: 3857, y: 1388, width: 133, height: 113 }),
      Wall1: tx({ id: "Stone.Wall1", atlas: 0, x: 3991, y: 1495, width: 103, height: 109 }),
    },
    Treasures: {
      Bone0: tx({ id: "Treasures.Bone0", atlas: 0, x: 202, y: 520, width: 98, height: 76 }),
      Bone: tx({ id: "Treasures.Bone", atlas: 0, x: 83, y: 638, width: 62, height: 60 }),
      Diamond: tx({ id: "Treasures.Diamond", atlas: 0, x: 4072, y: 603, width: 24, height: 22 }),
      DrillUpgrade0: tx({ id: "Treasures.DrillUpgrade0", atlas: 0, x: 83, y: 579, width: 70, height: 58 }),
      DrillUpgrade1: tx({ id: "Treasures.DrillUpgrade1", atlas: 0, x: 3978, y: 982, width: 100, height: 58 }),
      ...
      FishingPole: tx({ id: "Treasures.FishingPole", atlas: 0, x: 3857, y: 1353, width: 144, height: 34 }),
      GiftCard: tx({ id: "Treasures.GiftCard", atlas: 0, x: 2338, y: 180, width: 28, height: 16 }),
      GoldenIdolHappy: tx({ id: "Treasures.GoldenIdolHappy", atlas: 0, x: 0, y: 579, width: 82, height: 90 }),
      GoldenIdol: tx({ id: "Treasures.GoldenIdol", atlas: 0, x: 4039, y: 189, width: 50, height: 64 }),
      Heart0: tx({ id: "Treasures.Heart0", atlas: 0, x: 435, y: 520, width: 55, height: 42 }),
      ...
      Skull: tx({ id: "Treasures.Skull", atlas: 0, x: 4015, y: 787, width: 74, height: 46 }),
      Soap: tx({ id: "Treasures.Soap", atlas: 0, x: 3471, y: 641, width: 32, height: 40 }),
      Tea: tx({ id: "Treasures.Tea", atlas: 0, x: 366, y: 608, width: 48, height: 38 }),
    },
  };
}
