...
function txs<T>(tx: (data: TxData) => T) {
  return {
    CharacterShadowSmall: tx({ id: "CharacterShadowSmall", atlas: 0, x: 806, y: 263, width: 47, height: 13 }),
    CharacterShadow: tx({ id: "CharacterShadow", atlas: 0, x: 418, y: 277, width: 80, height: 19 }),
    Character: tx({ id: "Character", atlas: 0, x: 0, y: 0, width: 1000, height: 150 }),
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 756, y: 263, width: 49, height: 47 }),
    },
    Foliage: {
      ...
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 161, y: 280, width: 51, height: 47 }),
    },
    Font: {
    ...
    Stone: {
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 418, y: 297, width: 53, height: 24 }),
