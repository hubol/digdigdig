...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    CharacterShadowSmall: tx({ id: "CharacterShadowSmall", atlas: 0, x: 4049, y: 1073, width: 47, height: 13 }),
    ...
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 809, y: 677, width: 49, height: 47 }),
    ...
    Foliage: {
      ...
      DeadBush0: tx({ id: "Foliage.DeadBush0", atlas: 0, x: 774, y: 656, width: 34, height: 51 }),
      ...
      Grass0: tx({ id: "Foliage.Grass0", atlas: 0, x: 0, y: 739, width: 100, height: 43 }),
      Grass1: tx({ id: "Foliage.Grass1", atlas: 0, x: 4049, y: 1087, width: 47, height: 25 }),
      Grass2: tx({ id: "Foliage.Grass2", atlas: 0, x: 2236, y: 180, width: 101, height: 14 }),
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 861, y: 637, width: 51, height: 47 }),
    ...
    Font: {
      ...
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 0, y: 714, width: 102, height: 24 }),
    ...
    Hints: {
      ...
      ArrowLong: tx({ id: "Hints.ArrowLong", atlas: 0, x: 4055, y: 954, width: 34, height: 118 }),
      ...
      Arrow: tx({ id: "Hints.Arrow", atlas: 0, x: 101, y: 739, width: 24, height: 17 }),
      ...
      Cross1: tx({ id: "Hints.Cross1", atlas: 0, x: 412, y: 616, width: 35, height: 29 }),
      Cross: tx({ id: "Hints.Cross", atlas: 0, x: 641, y: 673, width: 60, height: 53 }),
      Filler0: tx({ id: "Hints.Filler0", atlas: 0, x: 2973, y: 267, width: 500, height: 280 }),
      LookEast: tx({ id: "Hints.LookEast", atlas: 0, x: 641, y: 628, width: 69, height: 44 }),
      ...
      NothingHere: tx({ id: "Hints.NothingHere", atlas: 0, x: 841, y: 520, width: 87, height: 44 }),
      ...
      Wasd: tx({ id: "Hints.Wasd", atlas: 0, x: 1010, y: 520, width: 68, height: 50 }),
    ...
    Hud: {
      ...
      DamageFresh: tx({ id: "Hud.DamageFresh", atlas: 0, x: 1079, y: 520, width: 64, height: 64 }),
      Damage: tx({ id: "Hud.Damage", atlas: 0, x: 1010, y: 571, width: 64, height: 64 }),
      EnergyBar: tx({ id: "Hud.EnergyBar", atlas: 0, x: 3975, y: 576, width: 109, height: 16 }),
      Energy: tx({ id: "Hud.Energy", atlas: 0, x: 702, y: 717, width: 48, height: 22 }),
      Life: tx({ id: "Hud.Life", atlas: 0, x: 4066, y: 919, width: 30, height: 22 }),
    ...
    Patch: {
      ...
      Shadow0: tx({ id: "Patch.Shadow0", atlas: 0, x: 3921, y: 1068, width: 127, height: 34 }),
      Splotch0: tx({ id: "Patch.Splotch0", atlas: 0, x: 3469, y: 818, width: 243, height: 217 }),
    },
    Shapes: {
      Confetti64: tx({ id: "Shapes.Confetti64", atlas: 0, x: 916, y: 581, width: 64, height: 64 }),
    ...
    Stone: {
      BrickWalkway0: tx({ id: "Stone.BrickWalkway0", atlas: 0, x: 0, y: 668, width: 126, height: 45 }),
      Headstone0: tx({ id: "Stone.Headstone0", atlas: 0, x: 929, y: 520, width: 80, height: 60 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 861, y: 612, width: 53, height: 24 }),
      Rock1: tx({ id: "Stone.Rock1", atlas: 0, x: 641, y: 579, width: 97, height: 48 }),
      Wall0: tx({ id: "Stone.Wall0", atlas: 0, x: 3921, y: 954, width: 133, height: 113 }),
      Wall1: tx({ id: "Stone.Wall1", atlas: 0, x: 127, y: 668, width: 103, height: 109 }),
    },
    Treasures: {
      Bone0: tx({ id: "Treasures.Bone0", atlas: 0, x: 742, y: 520, width: 98, height: 76 }),
      Bone: tx({ id: "Treasures.Bone", atlas: 0, x: 711, y: 656, width: 62, height: 60 }),
      Diamond: tx({ id: "Treasures.Diamond", atlas: 0, x: 3975, y: 483, width: 24, height: 22 }),
      DrillUpgrade0: tx({ id: "Treasures.DrillUpgrade0", atlas: 0, x: 739, y: 597, width: 70, height: 58 }),
      DrillUpgrade1: tx({ id: "Treasures.DrillUpgrade1", atlas: 0, x: 231, y: 685, width: 100, height: 58 }),
      DrillUpgrade2: tx({ id: "Treasures.DrillUpgrade2", atlas: 0, x: 332, y: 685, width: 100, height: 58 }),
      DrillUpgrade3: tx({ id: "Treasures.DrillUpgrade3", atlas: 0, x: 641, y: 520, width: 100, height: 58 }),
      FishingPole: tx({ id: "Treasures.FishingPole", atlas: 0, x: 3921, y: 919, width: 144, height: 34 }),
      GoldenIdolHappy: tx({ id: "Treasures.GoldenIdolHappy", atlas: 0, x: 4014, y: 593, width: 82, height: 90 }),
      GoldenIdol: tx({ id: "Treasures.GoldenIdol", atlas: 0, x: 810, y: 612, width: 50, height: 64 }),
      Heart0: tx({ id: "Treasures.Heart0", atlas: 0, x: 433, y: 693, width: 55, height: 42 }),
      InvisibleUnderwear: tx({ id: "Treasures.InvisibleUnderwear", atlas: 0, x: 2900, y: 386, width: 60, height: 36 }),
      RingWithGreenStone: tx({ id: "Treasures.RingWithGreenStone", atlas: 0, x: 412, y: 646, width: 34, height: 34 }),
      Skull: tx({ id: "Treasures.Skull", atlas: 0, x: 841, y: 565, width: 74, height: 46 }),
      Tea: tx({ id: "Treasures.Tea", atlas: 0, x: 751, y: 717, width: 48, height: 38 }),
    },
  };
}
