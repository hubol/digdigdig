...
function txs<T>(tx: (data: TxData) => T) {
  return {
    CharacterShadowSmall: tx({ id: "CharacterShadowSmall", atlas: 0, x: 0, y: 461, width: 47, height: 13 }),
    ...
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 101, y: 450, width: 49, height: 47 }),
    },
    Foliage: {
      ...
      Grass1: tx({ id: "Foliage.Grass1", atlas: 0, x: 48, y: 461, width: 47, height: 25 }),
      Grass2: tx({ id: "Foliage.Grass2", atlas: 0, x: 0, y: 402, width: 101, height: 14 }),
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 102, y: 402, width: 51, height: 47 }),
    ...
    Shapes: {
      ...
      Square32: tx({ id: "Shapes.Square32", atlas: 0, x: 0, y: 475, width: 32, height: 32 }),
