...
const atlases = [{ url: require("./atlas0.png"), texturesCount: 107 }];
...
function txs<T>(tx: (data: TxData) => T) {
  return {
    ...
    Dig: {
      Hole: tx({ id: "Dig.Hole", atlas: 0, x: 1140, y: 594, width: 49, height: 47 }),
    ...
    Enemy: {
      ...
      PencilProjectile: tx({ id: "Enemy.PencilProjectile", atlas: 0, x: 4075, y: 864, width: 19, height: 52 }),
      SpiderHurt: tx({ id: "Enemy.SpiderHurt", atlas: 0, x: 1140, y: 555, width: 58, height: 38 }),
      Spider: tx({ id: "Enemy.Spider", atlas: 0, x: 499, y: 668, width: 174, height: 38 }),
    },
    Foliage: {
      Bush0: tx({ id: "Foliage.Bush0", atlas: 0, x: 0, y: 520, width: 254, height: 125 }),
      DeadBush0: tx({ id: "Foliage.DeadBush0", atlas: 0, x: 220, y: 646, width: 34, height: 51 }),
      DeadBush1: tx({ id: "Foliage.DeadBush1", atlas: 0, x: 3421, y: 412, width: 26, height: 42 }),
      Flower0: tx({ id: "Foliage.Flower0", atlas: 0, x: 160, y: 932, width: 36, height: 24 }),
      Grass0: tx({ id: "Foliage.Grass0", atlas: 0, x: 494, y: 767, width: 100, height: 43 }),
      ...
      Leaves0: tx({ id: "Foliage.Leaves0", atlas: 0, x: 1199, y: 555, width: 51, height: 47 }),
      PineTree0: tx({ id: "Foliage.PineTree0", atlas: 0, x: 4027, y: 464, width: 65, height: 124 }),
      Trunk0: tx({ id: "Foliage.Trunk0", atlas: 0, x: 208, y: 646, width: 11, height: 84 }),
    },
    Font: {
      Diggit: tx({ id: "Font.Diggit", atlas: 0, x: 3985, y: 142, width: 54, height: 8 }),
      ErotixLight: tx({ id: "Font.ErotixLight", atlas: 0, x: 674, y: 685, width: 160, height: 34 }),
      Erotix: tx({ id: "Font.Erotix", atlas: 0, x: 499, y: 707, width: 160, height: 34 }),
      Flaccid: tx({ id: "Font.Flaccid", atlas: 0, x: 494, y: 742, width: 102, height: 24 }),
    ...
    Hints: {
      ...
      Book: tx({ id: "Hints.Book", atlas: 0, x: 835, y: 685, width: 113, height: 68 }),
      ConcentricCircles: tx({ id: "Hints.ConcentricCircles", atlas: 0, x: 2737, y: 534, width: 420, height: 418 }),
      Cross1: tx({ id: "Hints.Cross1", atlas: 0, x: 160, y: 957, width: 35, height: 29 }),
      Cross2: tx({ id: "Hints.Cross2", atlas: 0, x: 4074, y: 917, width: 21, height: 19 }),
      Cross: tx({ id: "Hints.Cross", atlas: 0, x: 99, y: 932, width: 60, height: 53 }),
      Filler0: tx({ id: "Hints.Filler0", atlas: 0, x: 2236, y: 344, width: 500, height: 280 }),
      LookEast: tx({ id: "Hints.LookEast", atlas: 0, x: 4005, y: 864, width: 69, height: 44 }),
      ...
      Wasd: tx({ id: "Hints.Wasd", atlas: 0, x: 4005, y: 909, width: 68, height: 50 }),
    ...
    Hud: {
      ...
      DamageFresh: tx({ id: "Hud.DamageFresh", atlas: 0, x: 595, y: 767, width: 64, height: 64 }),
      Damage: tx({ id: "Hud.Damage", atlas: 0, x: 4005, y: 960, width: 64, height: 64 }),
      EnergyBar: tx({ id: "Hud.EnergyBar", atlas: 0, x: 2236, y: 180, width: 109, height: 16 }),
      Energy: tx({ id: "Hud.Energy", atlas: 0, x: 260, y: 925, width: 48, height: 22 }),
      Life: tx({ id: "Hud.Life", atlas: 0, x: 3467, y: 790, width: 30, height: 22 }),
      Money: tx({ id: "Hud.Money", atlas: 0, x: 2577, y: 180, width: 46, height: 21 }),
      TreasureMessage: tx({ id: "Hud.TreasureMessage", atlas: 0, x: 2683, y: 151, width: 926, height: 50 }),
    },
    Misc: {
      FishingRodInUse: tx({ id: "Misc.FishingRodInUse", atlas: 0, x: 208, y: 738, width: 151, height: 127 }),
    ...
    Patch: {
      ...
      Shadow0: tx({ id: "Patch.Shadow0", atlas: 0, x: 1285, y: 520, width: 127, height: 34 }),
      Splotch0: tx({ id: "Patch.Splotch0", atlas: 0, x: 255, y: 520, width: 243, height: 217 }),
    },
    Shapes: {
      Confetti64: tx({ id: "Shapes.Confetti64", atlas: 0, x: 4005, y: 1025, width: 64, height: 64 }),
      Ellipse0: tx({ id: "Shapes.Ellipse0", atlas: 0, x: 674, y: 668, width: 53, height: 14 }),
      LightSmall0: tx({ id: "Shapes.LightSmall0", atlas: 0, x: 2529, y: 194, width: 19, height: 7 }),
      LightSmall1: tx({ id: "Shapes.LightSmall1", atlas: 0, x: 949, y: 683, width: 7, height: 9 }),
      ...
      Zigzag0: tx({ id: "Shapes.Zigzag0", atlas: 0, x: 61, y: 960, width: 37, height: 27 }),
    },
    Stone: {
      BrickWalkway0: tx({ id: "Stone.BrickWalkway0", atlas: 0, x: 1413, y: 520, width: 126, height: 45 }),
      Headstone0: tx({ id: "Stone.Headstone0", atlas: 0, x: 4012, y: 680, width: 80, height: 60 }),
      Rock0: tx({ id: "Stone.Rock0", atlas: 0, x: 597, y: 742, width: 53, height: 24 }),
      Rock1: tx({ id: "Stone.Rock1", atlas: 0, x: 99, y: 883, width: 97, height: 48 }),
      Wall0: tx({ id: "Stone.Wall0", atlas: 0, x: 360, y: 738, width: 133, height: 113 }),
      Wall1: tx({ id: "Stone.Wall1", atlas: 0, x: 660, y: 720, width: 103, height: 109 }),
    },
    Treasures: {
      Bone0: tx({ id: "Treasures.Bone0", atlas: 0, x: 0, y: 883, width: 98, height: 76 }),
      Bone: tx({ id: "Treasures.Bone", atlas: 0, x: 197, y: 925, width: 62, height: 60 }),
      Diamond: tx({ id: "Treasures.Diamond", atlas: 0, x: 3475, y: 722, width: 24, height: 22 }),
      DrillUpgrade0: tx({ id: "Treasures.DrillUpgrade0", atlas: 0, x: 764, y: 720, width: 70, height: 58 }),
      DrillUpgrade1: tx({ id: "Treasures.DrillUpgrade1", atlas: 0, x: 494, y: 811, width: 100, height: 58 }),
      DrillUpgrade2: tx({ id: "Treasures.DrillUpgrade2", atlas: 0, x: 360, y: 852, width: 100, height: 58 }),
      DrillUpgrade3: tx({ id: "Treasures.DrillUpgrade3", atlas: 0, x: 208, y: 866, width: 100, height: 58 }),
      FishingPole: tx({ id: "Treasures.FishingPole", atlas: 0, x: 1140, y: 520, width: 144, height: 34 }),
      GiftCard: tx({ id: "Treasures.GiftCard", atlas: 0, x: 2624, y: 180, width: 28, height: 16 }),
      GoldenIdolHappy: tx({ id: "Treasures.GoldenIdolHappy", atlas: 0, x: 4012, y: 589, width: 82, height: 90 }),
      GoldenIdol: tx({ id: "Treasures.GoldenIdol", atlas: 0, x: 309, y: 866, width: 50, height: 64 }),
      Heart0: tx({ id: "Treasures.Heart0", atlas: 0, x: 4039, y: 189, width: 55, height: 42 }),
      InvisibleUnderwear: tx({ id: "Treasures.InvisibleUnderwear", atlas: 0, x: 0, y: 960, width: 60, height: 36 }),
      RingWithGreenStone: tx({ id: "Treasures.RingWithGreenStone", atlas: 0, x: 220, y: 698, width: 34, height: 34 }),
      ...
      Soap: tx({ id: "Treasures.Soap", atlas: 0, x: 461, y: 852, width: 32, height: 40 }),
      Tea: tx({ id: "Treasures.Tea", atlas: 0, x: 1251, y: 555, width: 48, height: 38 }),
    },
  };
}
